...
import { Timestamp, addDoc, collection, onSnapshot, orderBy, query,doc,setDoc ,deleteDoc,getDocs} from 'firebase/firestore';
...
function MyState(props) {
    ...
    const toggleMode=()=>{
          if(mode=='light'){
            setMode('dark');         document.body.style.backgroundColor="rgb(17, 24, 39)";
          }
          else{
