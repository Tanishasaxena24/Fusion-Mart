...
// {user?.user?.email==="tanishasaxena2412@gmail.com" ?
//                   <div className="flow-root">
...
export default function Navbar() {
  ...
  const user = JSON.parse(localStorage.getItem('user'))
  console.log("user", user ? user.user.email : "No user found")
          ...
          <div className="">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className='px-2'>
                  <button onClick={toggleMode} className='px-3 py-1 rounded-md'>
                    {mode === 'light' ? <FiSun className='text-black' /> : <BsFillCloudSunFill className='text-white' />}
                  </button>
                </div>
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/cart'} className="group -m-2 flex items-center p-2" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    ...
                    <span className="bg-pink-500 rounded-full p-1 text-white ml-2 text-sm font-medium  group-" style={{ color: mode === 'dark' ? 'white' : '', }}>{cartItem.length}</span>
                    <span className="sr-only">items in cart, view bag</span>
                  </Link>
                </div>
              </div>
